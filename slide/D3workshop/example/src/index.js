    ...
    return (
      ...
      >
        ...
        <Slide  bgColor="primary">
          ...
          <CodePane textSize={"0.6em"} width="400"
            lang="javascript"
        ...
        <Slide transition={['spin']} bgColor="black">
         ...
         <Slide  bgColor="primary">
            <div className="d3string"><span>D</span>ata-<span>D</span>riven <span>D</span>ocuments</div>
        </Slide>           

        <Slide  bgColor="primary">
          <Typeface weight={600}>
            <Text  textAlign="left" textSize={"2em"}>データと要素の差分を判別するためのセレクターを提供するD3のコア機能</Text>
          </Typeface>
        </Slide>              
